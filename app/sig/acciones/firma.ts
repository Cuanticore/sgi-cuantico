...
// sostiene.
//
// **REQ-SIG-19 · P15 · las cinco escrituras viven en un solo lugar.** Hay dos vías para llegar
...
interface AsignacionParaAsentar {
  id: number;
  personaId: number;
  persona: {
    correo: string;
...
interface ContenidoParaAsentar {
  id: number;
  codigo: string;
  version: number;
...
function publicarLuego(evidenciaId: number): void {
