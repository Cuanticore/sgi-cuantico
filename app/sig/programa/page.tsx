...
// misma vista en `/sgsi/auditorias/programa` sin notarlo — con la cabecera editable, el
...
//
// Se consolida en `/sgsi/auditorias/programa`: vive junto a la lista de auditorías y su
...
export default function ProgramaPage() {
  permanentRedirect('/sgsi/auditorias/programa');
}
