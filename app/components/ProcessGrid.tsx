...
function SvgGauge({ pct, color }: { pct: number | null; color: string }) {
  ...
  return (
    <svg viewBox="0 0 50 50" className="w-[64px] h-[64px] shrink-0">
        ...
        {procesos.map(p => {
          ...
          return (
            <div
              ...
              className={`bg-white rounded-xl p-3 shadow-xs border flex items-center gap-2.5 cursor-pointer transition-all ${
                isSelected
