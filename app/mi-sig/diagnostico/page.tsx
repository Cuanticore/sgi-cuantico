...
const QUE_ABRE: Record<Permiso, string> = {
  ...
  'tecnologia:ver': 'Ver el mapa tecnológico, los ambientes y las dependencias',
  'tecnologia:escribir': 'Registrar despliegues, dependencias y productos',
  'tecnologia:administrar': 'Administrar los niveles del inventario y sus plantillas',
