...
export async function verificarMetricas(prisma: PrismaClient): Promise<boolean> {
  ...
  const checks: Esperado[] = [
    ...
    { etiqueta: 'En L3 o superior', esperado: 75, obtenido: m.enGestionado, tolerancia: 0 },
    { etiqueta: '% en L3 o superior', esperado: 87.2, obtenido: m.pctGestionado, tolerancia: 0.05 },
